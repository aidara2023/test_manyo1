...
RSpec.describe Task, type: :model do
  ...
  describe 'search function' do
    let!(:first_task) { FactoryBot.create(:task, title: 'first_task_title', deadline_on: Date.yesterday, priority: 'low', status: 'todo', user: user) }
    let!(:second_task) { FactoryBot.create(:second_task, title: "second_task_title", deadline_on: Date.today, priority: 'low', status: 'todo', user: user) }
    let!(:third_task) { FactoryBot.create(:third_task, title: "third_task_title", deadline_on: Date.tomorrow, priority: 'low', status: 'todo', user: user) }
